...
function single() {
  ...
  if (cornerModel.length > 0 && singleModel.length > 0 && rightModel.length === 0) {
    let singleSeatImg = document.getElementById("singleSeat");
    singleSeatImg.style.opacity = 0.1;
    singleSeatImg.disabled = true;
  }
  ...
  if (cornerModel.length > 0 && singleModel.length > 0 && rightModel.length > 0 && singleModelLeftSide.length > 0) {
    let singleSeatImg = document.getElementById("singleSeat");
    singleSeatImg.style.opacity = 0.1;
    singleSeatImg.disabled = true;
  }

  if (cornerModel.length === 0 && leftModel.length === 0 && singleModel.length === 0 && rightModel.length > 0) {
    let leftSeatImg = document.getElementById("leftSeat");
    leftSeatImg.style.opacity = 0.1;
    leftSeatImg.disabled = true;
  ...
  if (singleModelLeftSide.length > 0 && leftModelLeftSide.length > 0 && singleModel.length > 0 && rightModel.length > 0 && cornerModel.length === 0) {
    console.log("bbbb");
    let cornerSeatImg = document.getElementById("cornerSeat");
    cornerSeatImg.style.opacity = 1;
    cornerSeatImg.disabled = false;
